...
contains
   subroutine helpf()
      ...
      write(*,'(a35,10x,a)') "--cm <charge model>","# set charge model. Options: ''eeq'', ''ceh'', ''ceh_external'', ''ext'', ''extonlyq'', ''extscript''. DEFAULT: ''ceh''"
      ...
      write(*,'(a35,10x,a)') "--d4par d4file","# read D4 dispersion parameters from .d4par file"
